...
def main():
   ...
   with tab3:
      ...
      st.subheader('__A. Déficit Habitacional consolidado__')
      data = pd.read_csv('porcentajes_totales.csv',sep=';')
      data = data.set_index(['DATE'])
      aglomerado = st.selectbox(
        "Elija de la lista uno de los aglomerados para visualizar la evolución del déficit habitacional", 
        ('Gran La Plata','Bahía Blanca ‐ Cerri','Gran Rosario','Gran Santa Fé','Gran Paraná','Posadas', 'Gran Resistencia', 'Cdro. Rivadavia – Rada Tilly', 'Gran Mendoza', 
         ...
         'Mar del Plata ‐ Batán', 'Río Cuarto', 'San Nicolás – Villa Constitución', 'Rawson – Trelew', 'Viedma – Carmen de Patagones'),key=1)
      fig=go.Figure()
      ...
      fig.update_layout(title=f'Porcentaje de Déficit Habitacional para el aglomerado de {aglomerado}',xaxis_title='Fecha',yaxis_title='Hogares con déficit habitacional(%)', height=600)
      ...
      st.subheader('__B. Hogares por vivienda__')
      data = pd.read_csv('porcentajes_hogarxviv.csv',sep=';')
      data = data.set_index(['DATE'])
      aglomerado = st.selectbox(
        "Elija de la lista uno de los aglomerados para visualizar la evolución de las viviendas con más de un hogar", 
        ('Gran La Plata','Bahía Blanca ‐ Cerri','Gran Rosario','Gran Santa Fé','Gran Paraná','Posadas', 'Gran Resistencia', 'Cdro. Rivadavia – Rada Tilly', 'Gran Mendoza', 
         'Corrientes', 'Gran Córdoba', 'Concordia', 'Formosa', 'Neuquén – Plottier', 'S.del Estero ‐ La Banda', 'Jujuy ‐ Palpalá', 'Río Gallegos', 'Gran Catamarca', 'Salta', 
         'La Rioja', 'San Luis ‐ El Chorrillo', 'Gran San Juan', 'Gran Tucumán ‐ T. Viejo', 'Santa Rosa ‐ Toay', 'Ushuaia ‐ Río Grande', 'Ciudad de Buenos Aires', 'Partidos del GBA', 
         'Mar del Plata ‐ Batán', 'Río Cuarto', 'San Nicolás – Villa Constitución', 'Rawson – Trelew', 'Viedma – Carmen de Patagones'),key=2)
      fig=go.Figure()
      ...
      st.subheader('__C. Viviendas irrecuperables__')
      data = pd.read_csv('porcentajes_viv_irre.csv',sep=';')
      data = data.set_index(['DATE'])
      aglomerado = st.selectbox(
        "Elija de la lista uno delos aglomerados para visualizar la evolución de las viviendas irrecuperables", 
        ('Gran La Plata','Bahía Blanca ‐ Cerri','Gran Rosario','Gran Santa Fé','Gran Paraná','Posadas', 'Gran Resistencia', 'Cdro. Rivadavia – Rada Tilly', 'Gran Mendoza', 
         'Corrientes', 'Gran Córdoba', 'Concordia', 'Formosa', 'Neuquén – Plottier', 'S.del Estero ‐ La Banda', 'Jujuy ‐ Palpalá', 'Río Gallegos', 'Gran Catamarca', 'Salta', 
         'La Rioja', 'San Luis ‐ El Chorrillo', 'Gran San Juan', 'Gran Tucumán ‐ T. Viejo', 'Santa Rosa ‐ Toay', 'Ushuaia ‐ Río Grande', 'Ciudad de Buenos Aires', 'Partidos del GBA', 
         'Mar del Plata ‐ Batán', 'Río Cuarto', 'San Nicolás – Villa Constitución', 'Rawson – Trelew', 'Viedma – Carmen de Patagones'),key=3)
      fig=go.Figure()
      ...
      st.subheader('__D. Viviendas recuperables__')
      data = pd.read_csv('porcentajes_viv_recu.csv',sep=';')
      data = data.set_index(['DATE'])
      aglomerado = st.selectbox(
        "Elija de la lista uno delos aglomerados para visualizar la evolución de las viviendas recuperables", 
        ('Gran La Plata','Bahía Blanca ‐ Cerri','Gran Rosario','Gran Santa Fé','Gran Paraná','Posadas', 'Gran Resistencia', 'Cdro. Rivadavia – Rada Tilly', 'Gran Mendoza', 
         'Corrientes', 'Gran Córdoba', 'Concordia', 'Formosa', 'Neuquén – Plottier', 'S.del Estero ‐ La Banda', 'Jujuy ‐ Palpalá', 'Río Gallegos', 'Gran Catamarca', 'Salta', 
         'La Rioja', 'San Luis ‐ El Chorrillo', 'Gran San Juan', 'Gran Tucumán ‐ T. Viejo', 'Santa Rosa ‐ Toay', 'Ushuaia ‐ Río Grande', 'Ciudad de Buenos Aires', 'Partidos del GBA', 
         'Mar del Plata ‐ Batán', 'Río Cuarto', 'San Nicolás – Villa Constitución', 'Rawson – Trelew', 'Viedma – Carmen de Patagones'),key=4)
      fig=go.Figure()
      ...
      st.subheader('__E. Hacinamiento en viviendas__')
      data = pd.read_csv('porcentajes_viv_hac.csv',sep=';')
      data = data.set_index(['DATE'])
      aglomerado = st.selectbox(
        "Elija de la lista uno delos aglomerados para visualizar la evolución del hacinamiento en als viviendas", 
        ('Gran La Plata','Bahía Blanca ‐ Cerri','Gran Rosario','Gran Santa Fé','Gran Paraná','Posadas', 'Gran Resistencia', 'Cdro. Rivadavia – Rada Tilly', 'Gran Mendoza', 
         'Corrientes', 'Gran Córdoba', 'Concordia', 'Formosa', 'Neuquén – Plottier', 'S.del Estero ‐ La Banda', 'Jujuy ‐ Palpalá', 'Río Gallegos', 'Gran Catamarca', 'Salta', 
         'La Rioja', 'San Luis ‐ El Chorrillo', 'Gran San Juan', 'Gran Tucumán ‐ T. Viejo', 'Santa Rosa ‐ Toay', 'Ushuaia ‐ Río Grande', 'Ciudad de Buenos Aires', 'Partidos del GBA', 
         'Mar del Plata ‐ Batán', 'Río Cuarto', 'San Nicolás – Villa Constitución', 'Rawson – Trelew', 'Viedma – Carmen de Patagones'),key=5)
      fig=go.Figure()
